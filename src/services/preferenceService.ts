...
import { getJson, hasApiServer, patchJson, postJson } from './http'
...
export async function createPreference(tripId: string, payload: PreferencePayload): Promise<Preference | null> {
